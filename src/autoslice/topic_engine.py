...
_manual_timeline_doc_candidates = timeline_analysis.manual_timeline_doc_candidates
_find_manual_timeline_doc = timeline_analysis.find_manual_timeline_doc
_read_docx_lines = timeline_analysis.read_docx_lines
_parse_manual_timeline_lines = timeline_analysis.parse_manual_timeline_lines
_parse_elapsed_timeline_report_lines = timeline_analysis.parse_elapsed_timeline_report_lines
...
_manual_alignment_text = timeline_analysis.manual_alignment_text
_manual_semantic_core = timeline_analysis.manual_semantic_core
_srt_alignment_windows = timeline_analysis.srt_alignment_windows
_align_manual_timeline_entries_to_srt = timeline_analysis.align_manual_timeline_entries_to_srt
...
_topic_analysis_prompt_fingerprint = topic_analysis.topic_analysis_prompt_fingerprint
...
_manual_timeline_for_rebuilt_report = manual_artifacts.manual_timeline_for_rebuilt_report
...
# 因此工作 SRT 以 16 字为硬上限；最终 ASS 仍会按实际画布再做一次保险拆分。
