...
- `F1-CONTEXT` 已完成实现、主任务复核、完整门禁、独立提交、推送和 Windows/Linux CI 双绿，并已登记到总账。
- `F1-PROGRESSIVE` 已完成实现、主任务复核、完整门禁、独立提交、推送和 Windows/Linux CI 双绿，并已登记到总账。
- `T1-CONTRACT` 已完成实现、主任务复核、完整门禁、独立提交、推送和 Windows/Linux CI 双绿，并已登记到总账。
- `T1-API` 已完成实现、主任务复核、完整门禁、独立提交、推送和 Windows/Linux CI 双绿，并已登记到总账。
- `T1-UI` 已完成实现、主任务复核、完整门禁、独立提交、推送和 Windows/Linux CI 双绿，并已登记到总账。
- 下一个可执行 Action 为 `T1-MEDIA`，当前仅登记为 pending；不得在本次状态收口中自动开始。
...
3. `docs/plans/frontend-next.md` 的计划规格；
